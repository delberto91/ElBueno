...
//            NSLog(@"cellMessageRight");
            ...
            UIImageView *bubble = (UIImageView *)[cell viewWithTag:1001];
            [bubble setImage:[[UIImage imageNamed:@"bubble_sent"]imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
            [bubble setTintColor:[UIColor colorWithRed:215.0f/255.0f green:60.0f/255.0f blue:48.0f/255.0f alpha:1.0f]];
        }
        else {
//            NSLog(@"cellMessageLeft");
            cell = [tableView dequeueReusableCellWithIdentifier:cellMessageLeft forIndexPath:indexPath];
            UIImageView *bubble = (UIImageView *)[cell viewWithTag:1001];
            [bubble setImage:[[UIImage imageNamed:@"bubble_received"]imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate]];
            [bubble setTintColor:[UIColor colorWithRed:230.0f/255.0f green:230/255.0f blue:230/255.0f alpha:1.0f]];
        ...
        //labelMessage.font = [UIFont systemFontOfSize:labelMessage.font.pointSize];
