...
class DetalleProductoViewController: UIViewController {
    ...
    @objc func shoeAlert() {
        ...
        let seguirComprando = UIAlertAction(title: "Ir a mi carrito", style: UIAlertActionStyle.default) {
            UIAlertAction in
        ...
        let irACarrito = UIAlertAction(title: "Seguir comprando", style: UIAlertActionStyle.default) {
            UIAlertAction in
